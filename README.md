...
- **Light & Dark Modes**: Toggle between themes for a customized user experience.
- **LLM API Integration**: Utilizes the Gemini API for generating conversational responses.
